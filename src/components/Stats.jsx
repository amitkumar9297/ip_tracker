  ...
  return (
    <>
      <Stack
        ...
        boxShadow={{ base: "0", lg: "0px 0px 10px #D9D9D9" }}
        zIndex={"50"}
        bg={"white"}
        position={{ base: "relative", lg: "absolute" }}
        mt={{ base: "0px", lg: "12rem" }}
      >
        <Box
          w={{ base: "100%", lg: "24%" }}
        ...
        <Box
          ...
          pl={"0.5rem"}
          p={{ base: "1rem", lg: "0.1rem" }}
          borderLeft={{ base: "none", lg: "1px solid #333333" }}
          borderTop={{ base: "1px solid #333333", lg: "none" }}
        >
